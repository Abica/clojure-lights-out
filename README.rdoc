...
= Requirements
In order to build lights-out-clojure you will need the leiningen[link:http://github.com/technomancy/leiningen/] build tool.

If you don't have it already, get it now, it rocks[link:http://zef.me/2470/building-clojure-projects-with-leiningen]:
  cd ~/bin
